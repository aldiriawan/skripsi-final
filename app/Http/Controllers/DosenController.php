...
class DosenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query->orderBy('nama', 'asc'); // Mengurutkan nama dosen dari A-Z
        ...
        if ($dosen_id) {
            ...
            if ($selectedDosen) {
                ...
                // Menghitung jumlah akreditasi surat untuk setiap akreditasi (S1, S2, S3, S4, S5, S6, Q1, Q2, Q3, Q4)
                $akreditasiNasionalCounts = [
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/show')->with('success', 'Data Dosen baru sukses ditambahkan!');
    }
    ...
    public function update(Request $request, Dosen $dosen)
    {
        ...
        return redirect('/show')->with('success', 'Data Dosen berhasil diperbarui!');
    }

    public function destroy(Dosen $dosen)
    {
        Dosen::destroy($dosen->id);
        return redirect('/show')->with('success', 'Data Dosen berhasil dihapus!');
    }
